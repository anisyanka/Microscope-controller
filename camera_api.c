...
static int _exec_cmd(uint16_t cmd)
{
    ...
    case CAMERA_API_LAUNCH_VIDEO_TEST_VALUE:
        ...
        break;
    case CAMERA_API_LAUNCH_VIDEO_1080P_WEB_STREAMING_VALUE:
        strcpy(command, CAMERA_API_LAUNCH_1080P_WEB_STREAMING_VIDEO_SCRIPT);
        break;
    case CAMERA_API_LAUNCH_VIDEO_4K_WEB_STREAMING_VALUE:
        strcpy(command, CAMERA_API_LAUNCH_4K_WEB_STREAMING_VIDEO_SCRIPT);
        break;
    case CAMERA_API_LAUNCH_VIDEO_TEST_WEB_STREAMING_VALUE:
        strcpy(command, CAMERA_API_LAUNCH_TEST_WEB_STREAMING_VIDEO_SCRIPT);
        break;
    default:
