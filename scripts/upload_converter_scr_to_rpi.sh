...
cd ..
ssh $rpi_user@$rpi_ip "cd ~;mkdir -p $modbus_src_dir; mkdir -p $modbus_src_dir/jsmn; mkdir -p $modbus_src_dir/scripts; mkdir -p $modbus_src_dir/web_viewer; mkdir -p $modbus_src_dir/web_viewer/templates;" 
