...
gst-launch-1.0 -v v4l2src device=/dev/$video io-mode=4 ! image/jpeg,width=1920,height=1080,type=video,framerate=30/1 ! rtpjpegpay ! queue ! udpsink host=$HOST port=5602 > /dev/null &
